...
TOOL_SCHEMA = {
    ...
    "inputSchema": {
        ...
        "properties": {
            ...
            "json_mode": {
                "type": "boolean",
                "description": "If true, Gemini returns valid JSON.",
            },
            "list_sessions": {
                "type": "boolean",
...
# ── Implementation (unchanged from gemini_chat.py) ─────────────────────────
...
def _load_file_as_part(file_path: str) -> dict:
    ...
    if not mime_type:
        ...
        mime_map = {
            ...
            ".ts": "text/typescript", ".html": "text/html", ".xml": "text/xml",
...
def handle_consult(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        if session_id:
            ...
            return _ok_meta(response_text, session_id=session_id, model=session_model)
...
def _ok_meta(text: str, session_id: str = None, model: str = None, new_session: bool = False) -> Dict[str, Any]:
