...
class ApplyOperationsMixin:
    ...
    def apply(self, path: str = None, data: Dict = None, playthrough: str = "default"):
        ...
        from mind.physics.graph.graph_ops_types import ApplyResult, WriteError
        from mind.physics.graph.graph_ops_events import emit_event as _emit_event
    ...
    def _validate_link_targets(self, id1: str, id2: str, existing: Set[str], new: Set[str]):
        ...
        from mind.physics.graph.graph_ops_types import WriteError
