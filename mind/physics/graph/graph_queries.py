...
from mind.physics.graph.graph_query_utils import (
    SYSTEM_FIELDS,
    view_to_scene_tree,
)
from mind.physics.graph.graph_queries_moments import MomentQueryMixin
from mind.physics.graph.graph_queries_search import SearchQueryMixin
...
Error: {e}"""
    ...
    def _connect(self):
        ...
        if not self._adapter.health_check():
            from mind.infrastructure.database import clear_adapter_cache
            clear_adapter_cache()
