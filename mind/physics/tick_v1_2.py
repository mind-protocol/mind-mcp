...
from mind.physics.graph import GraphQueries, GraphOps
from mind.physics.tick_v1_2_types import TickResultV1_2
from mind.physics.tick_v1_2_queries import TickQueries
from mind.physics.graph.graph_query_utils import dijkstra_with_resistance, dijkstra_single_source
from mind.physics.constants import BLOCKED_PATH_RESISTANCE, MAX_PATH_HOPS, plutchik_intensity

# Import phases
from mind.physics.phases.generation import phase_generation
from mind.physics.phases.moment_draw import phase_moment_draw
from mind.physics.phases.moment_flow import phase_moment_flow
from mind.physics.phases.moment_interaction import phase_moment_interaction
from mind.physics.phases.narrative_backflow import phase_narrative_backflow
from mind.physics.phases.link_cooling import phase_link_cooling
from mind.physics.phases.completion import phase_completion
from mind.physics.phases.rejection import phase_rejection
...
class GraphTickV1_2:
    ...
    def _crystallize_actor_links(self, moment_id: str) -> int:
        ...
        try:
            ...
            from mind.physics.constants import CRYSTALLIZATION_WEIGHT
    ...
    def _energy_flows_through(
        ...
        from mind.physics.flow import energy_flows_through
