...
What `mind init` does:
1. Copies the protocol files to .mind-mcp/ in your project
2. Appends the protocol bootstrap to .mind-mcp/CLAUDE.md (creates it if missing)
...
def main():
    ...
    init_parser.add_argument(
        ...
        action="store_true",
        dest="no_force",
        help="Don't overwrite existing .mind-mcp/ directory (default: overwrite)"
    )
    init_parser.add_argument(
        "--dir", "-d",
        type=Path,
