...
from mind.models.base import MomentStatus
...
class CanonHolder:
    ...
    def no_contradiction(self, moment_id: str) -> Tuple[bool, List[str]]:
        ...
        """
        from mind.physics.constants import CONTRADICT_THRESHOLD
    ...
    def reject_moment(
        ...
        """
        from mind.physics.constants import REJECTION_RETURN_RATE
