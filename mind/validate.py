...
def check_protocol_installed(target_dir: Path) -> ValidationResult:
    """V6 (partial): Check that .mind-mcp/ exists."""
...
def generate_fix_prompt(target_dir: Path, results: List[ValidationResult]) -> str:
    ...
    for result in failed_results:
        ...
        if result.check_id == "V6" and "SYNC" in result.name:
            ...
            prompt_parts.append("Edit `.mind-mcp/state/SYNC_Project_State.md` and fill in:\n")
            ...
            prompt_parts.append("- Template: `.mind-mcp/templates/SYNC_TEMPLATE.md`\n")
            prompt_parts.append("- Protocol: `.mind-mcp/PROTOCOL.md` → \"SYNC files track current state\"\n\n")
            ...
            prompt_parts.append("### Reference\n")
            prompt_parts.append("- VIEW: `.mind-mcp/views/VIEW_Document_Create_Module_Documentation.md`\n")
            prompt_parts.append("- Templates: `.mind-mcp/templates/OBJECTIVES_TEMPLATE.md`, `PATTERNS_TEMPLATE.md`, `SYNC_TEMPLATE.md`\n\n")
            ...
            prompt_parts.append("### Reference\n")
            prompt_parts.append("- VIEW: `.mind-mcp/views/VIEW_Document_Create_Module_Documentation.md`\n")
            prompt_parts.append("- Templates: `.mind-mcp/templates/` (one for each doc type)\n\n")
