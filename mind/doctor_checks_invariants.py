...
DOCS: .mind-mcp/skills/SKILL_Test_Integrate_And_Gate_Completion.md
"""
...
def doctor_check_completion_gate(target_dir: Path, config: DoctorConfig) -> List[DoctorIssue]:
    ...
    Reads .mind-mcp/completion/*.yaml and reports incomplete modules.
...
def generate_completion_gate(
    ...
    Creates .mind-mcp/completion/{module}_gate.yaml
    """
