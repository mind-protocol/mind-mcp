    ...
    instructions = {
        "UNDOCUMENTED": {
            ...
            "docs_to_read": [
                ...
                ".mind-mcp/templates/OBJECTIVES_TEMPLATE.md",
                ".mind-mcp/templates/PATTERNS_TEMPLATE.md",
                ".mind-mcp/templates/SYNC_TEMPLATE.md",
                "modules.yaml",
            ],
...
3. For EACH missing doc type:
   ...
   c. If not found: create using templates from `.mind-mcp/templates/`
...
""",
        ...
        "LARGE_DOC_MODULE": {
            ...
            "docs_to_read": [
                ".mind-mcp/views/VIEW_Refactor_Improve_Code_Structure.md",
                issue.path,
            ],
