...
```
{target_dir}/.mind-mcp/PROTOCOL.md    # Navigation — what to load, where to update
{target_dir}/.mind-mcp/PRINCIPLES.md  # Stance — how to work well
```
...
```
{target_dir}/.mind-mcp/state/SYNC_Project_State.md
```
...
Based on what you need to do, load ONE view from `.mind-mcp/views/`:
